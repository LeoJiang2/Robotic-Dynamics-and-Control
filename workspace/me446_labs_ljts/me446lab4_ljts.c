...
//proportion control effort in base frame
float KPx = 500.0;
float KPy = 500.0;
float KPz = 500.0;

//derivative control effort in base frame
float KDx = 10.0;
float KDy = 10.0;
float KDz = 10.0;
...
float ff = 0.8; //friction multiplier
float Kt = 6.0;
...
//proportion control effort in n frame
float KPxn = 500.0;
float KPyn = 500.0;
float KPzn = 500.0;

//derivative control effort in n frame
float KDxn = 50.0;
float KDyn = 50.0;
float KDzn = 50.0;

//straight line trajectory distance
float dirx = 0.0;
float diry = 0.0;
float dirz = 0.0;
...
//    xd = 0.254; //desired worldframe coordinate
//    yd = 0.254;
//    zd = 0.254;
//
...
//    JFZ3 = -0.254*cos(theta3motor)*FZcmd/Kt;
    ...
    The first if statement switch between two states when one end of point is reached, 
    ...
    */
    ...
    // desired world coordinates multiply by rotation matrix
    xd = RT11*xdw+RT12*ydw+RT13*zdw;
    yd = RT21*xdw+RT22*ydw+RT23*zdw;
    zd = RT31*xdw+RT32*ydw+RT33*zdw;
    //calculating acutal world coordinates
    ...
    //acutal world coordinates multiply by rotation matrix
